...
function InstagramReelsViewsPage() {
    return (
        <div>
            <HeroSection title={"Buy Instagram Reels Views<br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Reels Views</span></h3>"} imgUrl={"/tubeviews-banner.png"} />
