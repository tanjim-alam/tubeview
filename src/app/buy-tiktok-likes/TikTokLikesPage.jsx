...
import tiktokLikesReviews from "../reviewData/tiktok/tiktokLikesReviews.json"
...
function TikTokLikesPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy TikTok Likes <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Likes</span></h3>"} imgUrl={"/hero-banner.webp"} />
            ...
            {/* <FaqSection
                ...
                faqData={faqData}
            /> */}
            {/* <ReviewsSection reviewsData={tiktokLikesReviews} /> */}
        </div>
    )
}
