...
function LinkedInFollowersPage() {
    return (
        <div>
            <HeroSection title={"Buy LinkedIn Followers <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Followers</span></h3>"} imgUrl={"/hero-banner.webp"} />
