    ...
    return (
        <div className='flex flex-col lg:flex-row'>
            <div className='lg:w-[80%] w-full m-auto border p-2 lg:p-10 mt-7 relative rounded-2xl shadow-[0_2px_2px_rgba(0,0,0,0.10)]'>
                <p className=' absolute top-[-19px] sm:left-[35%] left-[20%] lg:top-[-26px] lg:left-[40%] bg-white border py-1 px-4 lg:py-2 text-black lg:px-8 border-black rounded-md  text-lg font-semibold'>{packageData.serviceName || "Real YouTube Views"}</p>
                <div className='flex flex-col gap-4'>
                    <div className='lg:flex sm:flex grid grid-cols-2 w-full justify-between text-sm font-medium border-b border-black p-5 lg:bg-red-100 rounded-2xl'>
