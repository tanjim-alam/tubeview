            ...
            <div className='lg:w-[80%] xl:w-[70%] w-[100%] m-auto relative'>
                ...
                <div className=' lg:absolute w-full'>
                    <div className='flex justify-center items-center'>
                        <p className='text-center text-black shadow-[0_2px_2px_rgba(0,0,0,0.10)] bg-white lg:text-2xl text-xl font-semibold py-2 lg:px-8 px-4 rounded-3xl'>🚀 Empowering 100,000+ Creators Worldwide with TubeViews</p>
                    </div>
                </div>
            </div>
        </div>
