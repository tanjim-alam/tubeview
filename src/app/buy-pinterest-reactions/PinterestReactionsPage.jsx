...
import pinterestReactionsData from "../constant/pinterest/pinterestReactionsData.json";
import pinterestReactionsReviews from "../reviewData/pinterest/pinterestReactionsReviews.json"
...
function PinterestReactionsPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Pinterest Reaction <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Reaction</span></h3>"} imgUrl={"/fbBanner.png"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold text-black'>Buy Pinterest Reaction to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium text-black'>Get Real Pinterest Reaction and Boost Your Video Impressions.</p>
                    </div>
                    <ServiceCard packageData={pinterestReactionsData} />
                </div>
            </div>
            {/* package section end */}
            ...
            <FaqSection
                ...
                faqData={faqData}
            />
            <ReviewsSection reviewsData={pinterestReactionsReviews} />
        </div>
    )
}
