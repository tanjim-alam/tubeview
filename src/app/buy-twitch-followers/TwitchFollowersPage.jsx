...
import twitchFollowersData from "../constant/twitch/twitchFollowersData.json";
import twitchFollowersReviews from "../reviewData/twitch/twitchFollowersReviews.json"
...
function TwitchFollowersPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Twitch Followers <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Followers</span></h3>"} imgUrl={"/fbBanner.png"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold text-black'>Buy Twitch Followers to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium text-black'>Get Real Twitch Followers and Boost Your Video Impressions.</p>
                    </div>
                    <ServiceCard packageData={twitchFollowersData} />
                </div>
            </div>
            {/* package section end */}
            ...
            <FaqSection
                ...
                faqData={faqData}
            />
            <ReviewsSection reviewsData={twitchFollowersReviews} />
        </div>
    )
}
