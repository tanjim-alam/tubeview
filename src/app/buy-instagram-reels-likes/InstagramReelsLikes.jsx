...
function InstagramReelsLikesPage() {
    return (
        <div>
            <HeroSection title={"Buy Instagram Reels Likes<br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Reels Likes</span></h3>"} imgUrl={"/tubeviews-banner.png"} />
