...
function InstagramTargetLikesPage() {
    return (
        <div>
            <HeroSection title={"Buy Instagram Target<br/>Likes with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Target Likes</span></h3>"} imgUrl={"/tubeviews-banner.webp"} />
