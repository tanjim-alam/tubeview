        ...
        <div className='bg-white py-20'>
            <div className='w-[80%] m-auto'>
                ...
                <div className='mt-8 flex flex-col gap-6'>
                    ...
                    <div>
                        <h3 className='text-3xl font-bold'>Cookies and Web Beacons</h3>
                        <p className='text-[17px] text-slate-700 mt-3'>
                        ...
                        <p className='text-[17px] text-slate-700 mt-3'>
                            For more general information on cookies, please read <Link
                                className='text-secondary'
                                href={"www.privacypolicyonline.com/what-are-cookies/"}>“What Are Cookies”</Link>.
                        </p>
                    </div>
                    <div>
                        <h3 className='text-3xl font-bold'>Our Advertising Partners</h3>
                        <p className='text-[17px] text-slate-700 mt-3'>
                    ...
                    <div>
                        <h3 className='text-3xl font-bold'>Advertising Partners Privacy Policies</h3>
                        <p className='text-[17px] text-slate-700 mt-3'>
                    ...
                    <div>
                        <h3 className='text-3xl font-bold'>CCPA Privacy Rights (Do Not Sell My Personal Information)</h3>
                        <p className='text-[17px] text-slate-700 mt-3'>
