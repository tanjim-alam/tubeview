...
import linkedinLikesData from "../constant/linkedin/linkedinLikesData.json";
import linkedinLikesReviews from "../reviewData/linkedin/linkedinLikesReviews.json"
...
function LinkedInLikesPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy LinkedIn Likes <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Likes</span></h3>"} imgUrl={"/fbBanner.png"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold text-black'>Buy LinkedIn Likes to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium text-black'>Get Real LinkedIn Likes and Boost Your Video Impressions.</p>
                    </div>
                    <ServiceCard packageData={linkedinLikesData} />
                </div>
            </div>
            {/* package section end */}
            ...
            <FaqSection
                ...
                faqData={faqData}
            />
            <ReviewsSection reviewsData={linkedinLikesReviews} />
        </div>
    )
}
