...
function ThreadsCommentsPage() {
    return (
        <div>
            <HeroSection title={"Buy Threads Comments <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Comments</span></h3>"} imgUrl={"/tubeview-home.webp"} />
