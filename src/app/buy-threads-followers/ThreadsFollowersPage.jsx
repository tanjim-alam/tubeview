...
import threadsFollowersData from "../constant/threads/threadsFollowersData.json";
import threadsFollowersReviews from "../reviewData/threads/threadsFollowersReviews.json"


function ThreadsFollowersPage() {
    const featuresData = [
        {
            id: 1,
    ...
    return (
        <div>
            <HeroSection title={"Buy Threads Followers <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Followers</span></h3>"} imgUrl={"/fbBanner.png"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold text-black'>Buy Threads Followers to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium text-black'>Get Real Threads Followers and Boost Your Video Impressions.</p>
                    </div>
                    <ServiceCard packageData={threadsFollowersData} />
                </div>
            </div>
            {/* package section end */}
            ...
            <FeaturesSection featuresData={featuresData} heading={"🚀 Buy Snapchat Views Features With Tubeviews"} subHeading={"Buying Youtube views from Tubeviews can help you boost your video's visibility and reach."} />
            <ContentSection1
            ...
            <FaqSection
                ...
                faqData={faqData}
            />
            <ReviewsSection reviewsData={threadsFollowersReviews} />
        </div>
    )
}

export default ThreadsFollowersPage