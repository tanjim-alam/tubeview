...
function InstagramLikesPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Likes<br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Likes</span></h3>"} imgUrl={"https://userviral.b-cdn.net/assets/images/image-3.png"} />
