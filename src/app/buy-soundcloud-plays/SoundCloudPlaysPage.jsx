...
function SoundCloudPlaysPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy SoundCloud Plays <br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-secondary>Plays</span></h3>"} imgUrl={"/fbBanner.png"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold text-black'>Buy SoundCloud Plays to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start font-medium text-black'>Get Real SoundCloud Plays and Boost Your Video Impressions.</p>
                    </div>
            ...
            <FaqSection
                ...
                faqData={faqData}
            />
            <ReviewsSection reviewsData={scPlaysReviews} />
        </div>
    )
}
