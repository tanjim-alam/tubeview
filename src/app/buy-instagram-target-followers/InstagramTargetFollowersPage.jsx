...
function InstagramTargetFollowersPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Target<br/>Followers with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Target Followers</span></h3>"} imgUrl={"https://userviral.b-cdn.net/assets/images/image-3.png"} />
