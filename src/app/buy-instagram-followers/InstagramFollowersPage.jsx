...
function InstagramFollowersPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Followers<br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Followers</span></h3>"} imgUrl={"https://userviral.b-cdn.net/assets/images/image-3.png"} />
