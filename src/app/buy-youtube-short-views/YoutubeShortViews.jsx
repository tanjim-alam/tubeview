...
import youtubeShortViewsReviews from "../reviewData/youtubeShortViewsReviews.json"
    ...
    return (
        <div>
            ...
            <FaqSection
                ...
                faqData={faqData}
            />
            <ReviewsSection reviewsData={youtubeShortViewsReviews} />
        </div>
    )
}
