...
function YouTubeShortViewsPage() {
    return (
        <div>
            <HeroSection title={"Buy YouTube Short Views<br/>With Instant Delivery"} subTitle={"<h3>Buy YouTube <span class=text-secondary>Short Views</span></h3>"} imgUrl={"/tubeviews-banner.png"} />
