...
function InstagramCommentsPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Instagram Comments<br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Comments</span></h3>"} imgUrl={"https://userviral.b-cdn.net/assets/images/image-3.png"} />
