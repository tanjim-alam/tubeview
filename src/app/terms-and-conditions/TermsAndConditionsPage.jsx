                ...
                <div className='mt-6 flex flex-col gap-6'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        ...
                        <ul className='flex flex-col gap-3 list-disc list-inside'>
                            <li className='text-[17px] text-slate-700'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='text-3xl font-bold'>Hyperlinking to our Content</h3>
                        <p className='text-[17px] text-slate-700'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='text-3xl font-bold'>iFrames</h3>
                        <p className='text-[17px] text-slate-700'>
                            Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.
                        </p>
                    </div>
                    <div className='mt-8 flex flex-col gap-6'>
                        <h3 className='text-3xl font-bold'>Content Liability</h3>
                        <p className='text-[17px] text-slate-700'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='text-3xl font-bold'>Your Privacy</h3>
                        <p className='text-[17px] text-slate-700'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='text-3xl font-bold'>Reservation of Rights</h3>
                        <p className='text-[17px] text-slate-700'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='text-3xl font-bold'>Removal of links from our website</h3>
                        <p className='text-[17px] text-slate-700'>
