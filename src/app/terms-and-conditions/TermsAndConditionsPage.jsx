            ...
            <div className='lg:w-[80%] w-[90%] m-auto'>
                <div className='flex flex-col gap-6'>
                    ...
                    <p className='leading-relaxed text-slate-600'>
                        ...
                        Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the
                        process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client’s needs
                        in respect of provision of the Company’s stated services, in accordance with and subject to, prevailing law of Netherlands.
                ...
                <div className='mt-6 flex flex-col gap-6'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black'>Hyperlinking to our Content</h3>
                        <p className='leading-relaxed text-slate-600'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black'>iFrames</h3>
                        <p className='leading-relaxed text-slate-600'>
                            Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.
                        </p>
                    </div>
                    <div className='mt-8 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black '>Content Liability</h3>
                        <p className='leading-relaxed text-slate-600'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black'>Your Privacy</h3>
                        <p className='leading-relaxed text-slate-600'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black'>Reservation of Rights</h3>
                        <p className='leading-relaxed text-slate-600'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black'>Removal of links from our website</h3>
                        <p className='leading-relaxed text-slate-600'>
                    ...
                    <div className='mt-6 flex flex-col gap-6'>
                        <h3 className='lg:text-3xl text-2xl font-bold text-black'>Disclaimer</h3>
                        <p className='leading-relaxed text-slate-600'>
