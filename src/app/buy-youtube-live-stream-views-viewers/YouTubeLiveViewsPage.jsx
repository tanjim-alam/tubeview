            ...
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start text-black font-semibold'>Buy Youtube Views to Boost Engagements!</h3>
                        <p className='lg:text-xl text-lg text-center lg:text-start text-black font-medium'>Get Real Youtube Views and Boost Your Video Impressions.</p>
                    </div>
