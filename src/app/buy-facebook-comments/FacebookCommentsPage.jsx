    ...
    return (
        <div>
            <HeroSection
                ...
                imgUrl="https://i0.wp.com/vietnaminsider.vn/wp-content/uploads/2024/07/Screen-Shot-2024-07-30-at-00.05.14.png?resize=750%2C494&ssl=14"
            />
                ...
                <div className="lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto">
                    <div className="flex flex-col items-center gap-4">
                        <h3 className="lg:text-3xl text-2xl text-center text-black lg:text-start font-semibold">
                            Buy Youtube Views to Boost Engagements!
                        </h3>
                        <p className="lg:text-xl text-lg text-center text-black lg:text-start font-medium">
                            Get Real Youtube Views and Boost Your Video Impressions.
                        </p>
                    </div>
