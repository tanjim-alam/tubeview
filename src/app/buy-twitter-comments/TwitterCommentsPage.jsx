...
import twCommentsData from "../constant/twitter/twCommentsData.json"
...
function TwitterCommentsPage() {
    ...
    return (
        <div>
            <HeroSection title={"Buy Twitter Comments<br/> with Instant Delivery"} subTitle={"<h3>Buy More <span class=text-primary>Comments</span></h3>"} imgUrl={"https://userviral.b-cdn.net/assets/images/image-3.png"} />
            {/* package section start */}
            <div className='bg-white pb-16'>
                <div className='lg:w-[80%] w-[90%] flex flex-col gap-10 m-auto'>
                    <div className='flex flex-col items-center gap-4'>
                        <h3 className='lg:text-3xl text-2xl text-center lg:text-start font-semibold'>Buy Twitter Comments to Boost Engagements!</h3>
                    ...
                    <ServiceCard packageData={twCommentsData} />
                </div>
            </div>
            {/* package section end */}
            {/* <PackageSection /> */}
...
export default TwitterCommentsPage